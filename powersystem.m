            ...
            for b = 1:length(obj.systembusses)
                switch obj.systembusses(b).type
                    ...
                    case 'Ref'
                        ...
                        obj.systembusses(b).P = real(S)-obj.systembusses(b).Porig;
        ...
        function obj = displaysystemflows(obj)
            ...
            for b=1:length(obj.systembusses)
                switch obj.systembusses(b).P>=0
                    case 1
                        BusPowerIn = BusPowerIn + obj.systembusses(b).P +(strcmp(obj.systembusses(b).type,'Ref'))*obj.systembusses(b).Porig;
                    case 0
                        BusPowerOut = BusPowerOut + obj.systembusses(b).P + (strcmp(obj.systembusses(b).type,'Ref'))*obj.systembusses(b).Porig;
                end
                switch obj.systembusses(b).Q>=0
                    case 1
                        BusVARIn = BusVARIn + obj.systembusses(b).Q + (strcmp(obj.systembusses(b).type,'PV')+strcmp(obj.systembusses(b).type,'Ref'))*obj.systembusses(b).Qorig;
                    case 0
                        BusVAROut = BusVAROut + obj.systembusses(b).Q + (strcmp(obj.systembusses(b).type,'PV')+strcmp(obj.systembusses(b).type,'Ref'))*obj.systembusses(b).Qorig;
                end
            end
            for tl=1:length(obj.systemTLs)
